...
try:
            ...
            class Admin:
                        ...
                        def restore_clsacc(self,custid):
                                    cur.execute("SELECT * FROM PRABHAT.ret_cls WHERE customer_id=:1",{'1':custid})
                                    q=cur.fetchall()
                                    if q!=[]:
                                                cur.execute("""INSERT INTO  PRABHAT.customer VALUES (:pram0,:pram1,:pram2,:pram3,:pram4,:pram5,:pram6,:pram7,:pram8,:pram9,:pram10,:pram11,:pram12,:pram13)""",(q[0][0],q[0][1],q[0][2],q[0][3],q[0][4],q[0][5],q[0][6],q[0][7],q[0][8],q[0][9],q[0][10],q[0][11],q[0][12],q[0][13]))
                                                con.commit()
                                                cur.execute("DELETE FROM PRABHAT.ret_cls WHERE customer_id=:1",{'1':custid})
                                                con.commit()
                                                cur.execute("DELETE FROM PRABHAT.printhistory WHERE account_no=:1",{'1':custid})
                                                con.commit()
            ...
            class Account:
                        ...
                        def accountCls(self,custid):
                                    ...
                                    cur.execute("SELECT *FROM PRABHAT.customer WHERE customer_id=:1",{'1':custid})
                                    q=cur.fetchall()
                                    cur.execute("""INSERT INTO  PRABHAT.ret_cls VALUES (:pram0,:pram1,:pram2,:pram3,:pram4,:pram5,:pram6,:pram7,:pram8,:pram9,:pram10,:pram11,:pram12,:pram13)""",(q[0][0],q[0][1],q[0][2],q[0][3],q[0][4],q[0][5],q[0][6],q[0][7],q[0][8],q[0][9],q[0][10],q[0][11],q[0][12],q[0][13]))
                                    con.commit()
                                    ...
                                    if self.num==1:
                                                ...
                                                while True:
                                                            if c>=1 and c<=3:
                                                                        ...
                                                                        cur.execute("SELECT balance FROM PRABHAT.customer WHERE customer_id=:1",{'1':self.customerId})
                                                                        q=cur.fetchall()
                                                                        cur.execute("SELECT address,city,state,pincode FROM PRABHAT.customer WHERE customer_id=:1",{'1':self.customerId})
                                                                        q1=cur.fetchall()
                                                                        print("\nYour Amount: "+str(q[0][0])+" will be sent to the address: "+q1[0][0]+","+q1[0][1]+","+q1[0][2]+","+str(q1[0][3]))
                                                                        cur.execute("DELETE FROM PRABHAT.customer WHERE customer_id=:1",{'1':self.customerId})
                                                                        con.commit()
                                                                        break;
